...
- [`SimPEG/electromagnetics/utils/static_instrument/`](https://github.com/YmerFlow/simpeg/tree/simpleem3/SimPEG/electromagnetics/utils/static_instrument) — Custom instrument classes
